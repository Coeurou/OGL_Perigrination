...
bool OGLCube::InitVertices(std::array<glm::vec3, 8> data)
{
    ...
    auto back = Quad(data[4], data[5], data[6], data[7]);
    auto left = Quad(data[0], data[4], data[5], data[3]);
    auto right = Quad(data[1], data[2], data[6], data[7]);
    auto top = Quad(data[2], data[3], data[5], data[6]);
    auto bottom = Quad(data[0], data[4], data[7], data[1]);
